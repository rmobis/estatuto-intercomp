...
\begin{article}
	Uma entidade \textbf{participante} será ser expulsa por votação das entidades \textbf{participantes} se maioria qualificada de 2/3 (dois terços) forem a favor da expulsão. A entidade expulsa poderá voltar a participar de uma edição posterior caso a Comissão Organizadora julgue conveniente.
\end{article}